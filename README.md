...
| GPT-OSS 20B                    | Reasoning (SMDDP, SFT, MXFP4)         | [Notebook](https://github.com/aws-samples/amazon-sagemaker-generativeai/blob/main/3_distributed_training/models/openai--gpt-oss/finetune_gpt_oss_hyperpod_recipes_eks.ipynb) | SageMaker HyperPods (EKS)          | Hugging Face Trainer, MXFP4                                                       |
