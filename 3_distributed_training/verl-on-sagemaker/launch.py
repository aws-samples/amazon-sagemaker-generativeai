...
verl_image = '364430515305.dkr.ecr.us-east-2.amazonaws.com/sagemaker-verl-training:verl-py310-torch26-vllm083'
...
source_code = SourceCode(
    ...
    # command='''python3 /opt/ml/input/data/code/verl/verl/trainer/main_ppo.py \
    # algorithm.adv_estimator=grpo \
    # data.train_files=/opt/ml/input/data/gsm8k/train.parquet \
    # data.val_files=/opt/ml/input/data/gsm8k/test.parquet \
