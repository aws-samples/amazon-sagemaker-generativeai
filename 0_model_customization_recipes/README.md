...
| Qwen/Qwen3-VL-4B-Instruct | Image, Text to Text | No | ✅ [QLoRA](supervised_finetuning/sagemaker_code/hf_recipes/Qwen/Qwen3-VL-4B-Instruct-vanilla-peft-qlora.yaml) | - | ✅ [Full](supervised_finetuning/sagemaker_code/hf_recipes/Qwen/Qwen3-4B-vanilla-full.yaml) | 📓 [Notebook](supervised_finetuning/finetune--Qwen--Qwen3-VL-4B-Instruct.ipynb) | Vision-language model with enhanced capabilities |
| Qwen/Qwen3-4B | Text to Text | Yes | ✅ [QLoRA](supervised_finetuning/sagemaker_code/hf_recipes/Qwen/Qwen3-4B-vanilla-peft-qlora.yaml) | - | ✅ [Full](supervised_finetuning/sagemaker_code/hf_recipes/Qwen/Qwen3-4B-Instruct-vanilla-full.yaml) | 📓 [Notebook](supervised_finetuning/finetune--Qwen--Qwen3-4B.ipynb) | Compact Reasoning model with Tool Calling |
| | | | | | | | |
| **🧠 DeepSeek** | | | | | | | |
