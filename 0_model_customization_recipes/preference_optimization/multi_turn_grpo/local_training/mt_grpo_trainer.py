...
class ScriptArguments:
    ...
    max_train_samples: Optional[int] = field(default=None, metadata={"help": "Max number of training samples"})
...
def main():
    ...
    # Load dataset
    dataset = load_triviaqa_dataset(env.system_prompt, max_samples=script_args.max_train_samples)
